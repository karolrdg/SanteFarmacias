...
export default function ListaMed() {
  ...
  let listaMedicamentos = JSON.parse(localStorage.getItem("ListaMed"));
 
  const [listaAnterior, setListaAnterior] = useState(JSON.parse(localStorage.getItem("ListaMed")))
  let novaLista;
  ...
  function apagaMedicamento(id) {
    ...
    localStorage.setItem("ListaMed", JSON.stringify(novaLista));
